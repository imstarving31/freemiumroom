...
export default function Header() {
  ...
  return (
    <header className="main-header w-full bg-white flex justify-between items-center px-8 py-3 border-b shadow-sm">
      <Link to="/" className="logo-brand flex-shrink-0 flex items-center gap-2">
        <img src="/logoFR.jpg" alt="Logo" className="header-logo-img" />
        <span>FreemiumRoom</span>
      </Link>
            ...
            <div className="user-profile-wrapper" ref={dropdownRef}>
              ...
              {dropdownOpen && (
                <div className="user-dropdown-menu">
                  {/* Khối 1: Avatar, fullName, phoneNumber */}
                  <div className="dropdown-block profile-info">
                    ...
                    <div className="profile-text">
                      ...
                      <div className="profile-phone">{currentUser.phoneNumber || 'Chưa cập nhật SĐT'}</div>
                    </div>
                  </div>
